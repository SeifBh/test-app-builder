                    ...
                    <IgrList className={classes("list")} key={uuid()}>
                      <IgrListItem key={uuid()}>
                        <div slot="start" key={uuid()}>
                          <IgrAvatar shape="circle" className={classes("avatar_2")} key={uuid()}>
                      ...
                      <IgrListItem key={uuid()}>
                        <div slot="start" key={uuid()}>
                          <IgrAvatar shape="circle" className={classes("avatar_3")} key={uuid()}>
                            <span className={classes("material-icons icon_1")} key={uuid()}>
                              <span key={uuid()}>insert_drive_file</span>
                            </span>
                          </IgrAvatar>
                  ...
                  <IgrAccordion singleExpand="true" className={classes("accordion")}>
                    <IgrExpansionPanel indicatorPosition="end" key={uuid()}>
                      <IgrList className={classes("list")} key={uuid()}>
                        <IgrListItem key={uuid()}>
                          <div slot="start" key={uuid()}>
                            <IgrAvatar src="/src/assets/Calendar-Avatar-Icon.svg" className={classes("avatar_4")} key={uuid()}></IgrAvatar>
                          </div>
                          <div key={uuid()}>
                        ...
                        <IgrListItem key={uuid()}>
                          <div slot="start" key={uuid()}>
                            <IgrAvatar src="/src/assets/Calendar-Avatar-Icon.svg" className={classes("avatar_5")} key={uuid()}></IgrAvatar>
                          </div>
                          <div key={uuid()}>
                            <div className={classes("column-layout group_16")} key={uuid()}>
                              <div className={classes("row-layout group_17")}>
                        ...
                        <IgrListItem key={uuid()}>
                          <div slot="start" key={uuid()}>
                            <IgrAvatar src="/src/assets/Calendar-Avatar-Icon.svg" className={classes("avatar_6")} key={uuid()}></IgrAvatar>
                          </div>
                          <div key={uuid()}>
                            <div className={classes("column-layout group_16")} key={uuid()}>
                              <div className={classes("row-layout group_17")}>
